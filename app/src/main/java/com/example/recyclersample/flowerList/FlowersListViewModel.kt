...
class FlowersListViewModel(val dataSource: DataSource) : ViewModel() {
    ...
    fun insertFlower(flowerName: String?, flowerDescription: String?, tamanio: String?, tipo: String?, nombreCientifico: String?, color: String?) {
        if (flowerName == null || flowerDescription == null || tamanio == null || tipo == null || nombreCientifico == null || color == null) {
            return
        }
